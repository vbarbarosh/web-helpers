...
<vb-data-vars v-slot="vars" :vars="{conn: null, db: null, col: null, doc: null}">
    <reset-on-change :vars="vars" chain="conn,db,col,doc">
        <vb-breadcrumbs :vars>
            <vb-breadcrumbs-item value="root" label="Connections">
            ...
            <vb-breadcrumbs-item :value="vars.conn" label="Databases">
            ...
            <vb-breadcrumbs-item :value="vars.db" label="Collections">
            ...
            <vb-breadcrumbs-item :value="vars.col" label="Documents">
            ...
            <vb-breadcrumbs-item :value="vars.doc" label="Document Details">
