Object.assign(window, {
    ...
    mongo_collections_create: (conn, db, body) => http_post_json(`/api/v1/mongo/${conn}/${db}`, body),
    mongo_collections_remove: (conn, db, col) => http_delete(`/api/v1/mongo/${conn}/${db}/${col}`),
